...
contract SmartContractWallet {
  ...
  constructor() {
    //instantiate a payable address
    //msg.sender is always the user calling the contract, in that case is the deployer
  ...
  function transfer(address payable _to, uint _amount, bytes memory _payload) public returns (bytes memory){
    //check if the owner is the one calling the function
